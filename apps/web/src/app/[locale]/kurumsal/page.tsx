                        ...
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div className="p-6 bg-white border border-slate-200 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                                    <div className="w-12 h-12 rounded-xl bg-sky-400 flex items-center justify-center text-white mb-4 shadow-lg shadow-blue-500/30">
            ...
            <section className="py-16 lg:py-24">
                <div className="container px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                        <div className="p-8 lg:p-12 bg-gradient-to-br from-blue-50 to-white border border-sky-500/15 rounded-3xl shadow-sm hover:shadow-lg transition-all duration-300">
                            <div className="flex items-center gap-4 mb-6">
                                <div className="w-14 h-14 rounded-2xl bg-sky-500 flex items-center justify-center shadow-xl shadow-blue-600/20">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <Link
                                    ...
                                    className="px-10 py-5 bg-sky-500 text-white rounded-2xl font-bold hover:bg-sky-500/80 transition-all flex items-center justify-center gap-3 shadow-lg shadow-blue-600/30 hover:scale-105"
                                >
                                    {t('ctaButton1')}
