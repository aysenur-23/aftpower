            ...
            <div className="min-h-screen bg-white flex items-center justify-center pt-24 pb-12 px-4">
                <div className="max-w-md w-full text-center space-y-8">
                    ...
                    <div className="pt-4">
                        <Link
                            href={`/${locale}/`}
                            className="inline-flex items-center gap-2 px-8 py-4 bg-sky-500 text-white rounded-2xl font-bold hover:bg-sky-600 transition-all shadow-xl"
                        >
                            ...
                            <form onSubmit={handleSubmit} className="space-y-10">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center gap-3 border-b border-slate-100 pb-3">
                                        <div className="w-8 h-8 rounded-lg bg-sky-500/5 text-sky-500 flex items-center justify-center">
