...
export default function SiteHeader() {
    ...
    return (
        <header
            ...
            style={{ backgroundColor: 'rgba(15, 23, 42, 0.97)', backdropFilter: 'blur(20px)', borderBottom: '1px solid rgba(249, 115, 22, 0.15)' }}
        >
            {/* Top accent line */}
            ...
            <div className="container px-3 sm:px-4 lg:px-8 flex h-16 sm:h-18 items-center justify-between">
                ...
                <Link href={`/${locale}/`} className="flex items-center gap-3 group" onClick={handleLinkClick}>
                    ...
                    <div className="hidden sm:flex flex-col leading-none">
                        <span className="font-brand text-white font-bold tracking-widest text-sm lg:text-base group-hover:text-orange-400 transition-colors duration-300">AFT POWER</span>
                        <span className="text-orange-500 text-[9px] tracking-[0.25em] uppercase font-body font-medium">Energy Solutions</span>
                    </div>
                </Link>
                        ...
                        >
                            <Link
                                ...
                                className={cn(
                                    ...
                                    activeMegaMenu === item.hasMegaMenu && "text-orange-400",
                                    "after:absolute after:bottom-0 after:left-0 after:right-0 after:h-[2px] after:bg-orange-500 after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 after:origin-center"
                                )}
                            ...
                            >
                                ...
                                {item.hasMegaMenu && <ChevronDown className={cn(
                                    "h-3.5 w-3.5 text-neutral-500 group-hover:text-orange-400 transition-all duration-200",
                                    activeMegaMenu === item.hasMegaMenu && "rotate-180 text-orange-400"
                                )} />}
                            </Link>
                            ...
                            {item.hasMegaMenu === 'products' && activeMegaMenu === 'products' && (
                                <div
                                    ...
                                    style={{ background: 'rgba(10, 15, 30, 0.98)', backdropFilter: 'blur(20px)', borderBottom: '1px solid rgba(249, 115, 22, 0.2)' }}
                                ...
                                >
                                    <div className="max-w-7xl mx-auto px-6 py-8">
                                        <div className="flex gap-8">
                                            {/* Sidebar Categories */}
                                            <div className="w-64 shrink-0 border-r border-white/10 pr-6">
                                                <h3 className="text-[10px] font-semibold text-orange-500 uppercase tracking-[0.2em] mb-4 px-3 font-brand">
                                                    {t('categories')}
                                                </h3>
                                            ...
                                            <div className="flex-1">
                                                <div className="flex items-center justify-between mb-6">
                                                    <h3 className="text-xs font-bold text-white uppercase tracking-[0.15em] font-brand">
                                                ...
                                                <div className="grid grid-cols-4 gap-3">
                                                    {productCategories[activeProductCategory].products.map((product) => (
                                                        <Link
                                                            ...
                                                            className="group/card bg-white/3 hover:bg-white/8 border border-white/8 hover:border-orange-500/40 p-4 transition-all duration-300 hover:-translate-y-1 block"
                                                            onClick={handleLinkClick}
                                                        >
                                                            <div className="aspect-square relative w-full overflow-hidden mb-3 bg-white/5 group-hover/card:bg-white/10 transition-colors">
                                                                <Image
                                                                    src={product.image}
                                                            ...
                                                            <div className="space-y-1">
                                                                <div className="text-[9px] font-bold text-orange-500 uppercase tracking-[0.2em] mb-1 opacity-0 group-hover/card:opacity-100 transition-opacity duration-300 font-brand">
                                                                    AFT Power
                                                                </div>
                                                                <p className="text-[12px] font-semibold text-neutral-200 group-hover/card:text-white transition-colors line-clamp-2 leading-snug font-body">
                                                    ...
                                                    <Link
                                                        ...
                                                        className="group/card bg-orange-500/5 hover:bg-orange-500/15 border border-orange-500/20 hover:border-orange-500/60 p-4 transition-all duration-300 hover:-translate-y-1 block"
                                                        onClick={handleLinkClick}
                                                    >
                                                        <div className="aspect-square relative w-full overflow-hidden mb-3 flex items-center justify-center">
                                                            <div className="w-14 h-14 bg-orange-500/20 group-hover/card:bg-orange-500/40 flex items-center justify-center transition-all duration-300">
                                                                <ArrowRight className="w-7 h-7 text-orange-400 group-hover/card:text-orange-300 transition-colors duration-300" />
                                                            </div>
                                                        </div>
                                                        <div className="text-center">
                                                            <p className="text-[12px] font-semibold text-orange-400 group-hover/card:text-orange-300 transition-colors font-body">
                                                                {t('viewAllProducts')}
                                                            </p>
                                                        </div>
                                                    </Link>
                ...
                <div className="hidden lg:flex items-center space-x-3 xl:space-x-4">
                    ...
                    <div className="relative">
                        <button
                            ...
                            className="flex items-center gap-1.5 text-neutral-400 hover:text-orange-400 px-3 py-2 transition-all duration-200 border border-white/10 hover:border-orange-500/40 text-xs font-body"
                        ...
                        {isLangMenuOpen && (
                            <div className="absolute right-0 mt-2 w-40 py-1 z-50" style={{ background: 'rgba(10, 15, 30, 0.98)', border: '1px solid rgba(249, 115, 22, 0.2)' }}>
                                {languages.map((lang) => (
                                    <Link
                                        key={lang.code}
                                        href={`/${lang.code}/`}
                                        className={cn(
                                            "flex items-center gap-2 px-3 py-2 text-sm hover:bg-orange-500/10 transition-colors font-body",
                                            locale === lang.code ? "text-orange-400" : "text-neutral-400 hover:text-white"
                                        )}
                    ...
                    <Link
                        ...
                        style={{ background: 'linear-gradient(135deg, #f97316, #ea580c)', clipPath: 'polygon(0 0, calc(100% - 8px) 0, 100% 8px, 100% 100%, 8px 100%, 0 calc(100% - 8px))' }}
                        onMouseEnter={e => { (e.currentTarget as HTMLElement).style.boxShadow = '0 0 25px rgba(249, 115, 22, 0.5)'; }}
                ...
                <div className="lg:hidden flex items-center gap-2">
                    <div className="relative">
                        <button
                            onClick={() => setIsLangMenuOpen(!isLangMenuOpen)}
                            className="flex items-center gap-1 text-neutral-400 hover:text-orange-400 px-2.5 py-2 transition-all border border-white/10 hover:border-orange-500/30"
                            aria-label="Change language"
                        >
                            ...
                            <div className="absolute right-0 mt-2 w-40 py-1 z-50" style={{ background: 'rgba(10, 15, 30, 0.98)', border: '1px solid rgba(249, 115, 22, 0.2)' }}>
                                {languages.map((lang) => (
                                    <Link
                                        ...
                                        href={`/${lang.code}/`}
                                        className={cn(
                                            "flex items-center gap-2 px-3 py-2 text-sm hover:bg-orange-500/10 transition-colors",
                                            locale === lang.code ? "text-orange-400" : "text-neutral-400 hover:text-white"
                                        )}
                                        onClick={() => setIsLangMenuOpen(false)}
                                    >
                    ...
                    <button
                        ...
                        className="text-neutral-300 hover:text-orange-400 h-10 w-10 flex items-center justify-center border border-white/10 hover:border-orange-500/40 transition-all duration-200"
            ...
            {/* Mobile Navigation */}
            {isMobileMenuOpen && (
                <div className="lg:hidden max-h-[80vh] overflow-y-auto" style={{ background: 'rgba(10, 15, 30, 0.99)', borderTop: '1px solid rgba(249, 115, 22, 0.15)' }}>
                    <nav className="container px-4 py-4 space-y-1">
                        <Link
                            href={`/${locale}/`}
                            className="block px-3 py-3 text-sm font-medium text-neutral-300 hover:text-orange-400 hover:bg-white/5 transition-colors font-body"
                        ...
                        <div className="border-b border-white/8 pb-2">
                            <button
                                ...
                                className="w-full flex items-center justify-between px-3 py-3 text-sm font-medium text-neutral-300 hover:text-orange-400 hover:bg-white/5 transition-colors font-body"
                            >
                                <span>{t('products')}</span>
                                <ChevronDown className={cn("h-4 w-4 transition-transform", mobileProductsOpen && "rotate-180 text-orange-400")} />
                            </button>
                                ...
                                <div className="mt-1 ml-2 space-y-0.5">
                                    {productCategories.map((cat) => (
                                        <div key={cat.id}>
                                            ...
                                            {mobileActiveCategoryId === cat.id && (
                                                <div className="mt-1 ml-3 space-y-0.5 border-l border-orange-500/30 pl-3">
                                                    {cat.products.map((product) => (
                                                        <Link
                                                            key={product.slug}
                                                            href={`/${locale}/urunlerimiz/${product.slug}/`}
                                                            className="block px-3 py-2 text-xs text-neutral-500 hover:text-orange-400 hover:bg-orange-500/5 transition-colors font-body"
                                                            onClick={() => setIsMobileMenuOpen(false)}
                                                        >
                                                            {product.name[locale]}
                                                        </Link>
                                                    ...
                                                    <Link
                                                        ...
                                                        className="block px-3 py-2 text-xs font-medium text-orange-500 hover:bg-orange-500/10 transition-colors font-body"
                                                        onClick={() => setIsMobileMenuOpen(false)}
                                                    >
                                                        {t('viewAll')} →
                                                    </Link>
                                    ...
                                    <Link
                                        href={`/${locale}/urunlerimiz/`}
                                        className="block px-3 py-2.5 text-xs font-bold text-orange-500 hover:bg-orange-500/10 transition-colors font-body"
                                        onClick={() => setIsMobileMenuOpen(false)}
                                    >
                                        {t('viewAllProducts')} →
                                    </Link>
                        ...
                        <div className="border-b border-white/8 pb-2">
                            ...
                            >
                                ...
                                <ChevronDown className={cn("h-4 w-4 transition-transform", mobileServicesOpen && "rotate-180 text-orange-400")} />
                            </button>
                                        ...
                                        <div key={cat.id}>
                                            {cat.services.map((service) => (
                                                <Link
                                                    key={service.slug}
                                                    href={`/${locale}/hizmetlerimiz/${service.slug}/`}
                                                    className="block px-3 py-2.5 text-xs text-neutral-500 hover:text-orange-400 hover:bg-white/5 transition-colors font-body"
                                                    onClick={() => setIsMobileMenuOpen(false)}
                                                >
                                                    {service.name[locale]}
                                                </Link>
